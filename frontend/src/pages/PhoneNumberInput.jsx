...
const PhoneNumberInput = ({ value = "", onChange }) => {
  // value represents the phone number part (without country code)
    ...
    <div className="w-full relative flex items-center space-x-2 ">
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center justify-between p-2 border rounded w-32 text-left bg-white"
        >
        ...
        {dropdownOpen && (
          <ul className="absolute z-10 mt-1 w-32 bg-white border rounded shadow-lg max-h-48 overflow-y-auto">
