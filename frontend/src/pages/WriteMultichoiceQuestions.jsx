...
const MultiChoiceQuestions = () => {
  ...
  if (examSubmitted) {
    return (
      ...
      >
        You have written the exam. Redirecting to the student page...
      </motion.div>
    );
  }
            ...
            <div className="flex justify-between mt-6">
              ...
              {currentQuestion < questions.length - 1 ? (
                ...
                <motion.button
                  ...
                  disabled={submitting}
                  className="px-6 py-3 bg-green-600 text-white rounded-lg shadow-md hover:bg-green-700 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                >
