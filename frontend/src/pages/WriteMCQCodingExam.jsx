...
//   // Unified submission logic with confirmation
...
//         await axios.post("http://localhost:5001/api/submit", { submissions: submissionData });
...
//       <div className="w-11/12 max-w-4xl bg-gray-800/90 p-8 rounded-xl shadow-2xl h-[full] flex flex-col border border-gray-700">
//         {/* Progress Indicator */}
